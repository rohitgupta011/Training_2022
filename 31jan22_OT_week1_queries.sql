...
--Creating Tables 
CREATE TABLE regions(region_id NUMBER(10)primary key,region_name VARCHAR2(50)not null);
...
CREATE TABLE countries
 ...
 CREATE TABLE warehouses
  ...
  (
    employee_id NUMBER CONSTRAINT PK_employees_employee_id PRIMARY KEY,
